...
module AFAProcessFunction_srcNet_m_axi
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
...
//------------------------Instantiation------------------
// AFAProcessFunction_srcNet_m_axi_write
AFAProcessFunction_srcNet_m_axi_write #(
...
// AFAProcessFunction_srcNet_m_axi_read
AFAProcessFunction_srcNet_m_axi_read #(
    .C_ID_WIDTH        ( C_ID_WIDTH ),
    .C_ADDR_WIDTH      ( C_ADDR_WIDTH ),
    .C_TARGET_ADDR     ( C_TARGET_ADDR ),
...
module AFAProcessFunction_srcNet_m_axi_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH      = 16,
    DEPTH_BITS = 4
...
module AFAProcessFunction_srcNet_m_axi_decoder
#(parameter
    DIN_WIDTH       = 3
)(
...
module AFAProcessFunction_srcNet_m_axi_read
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_TARGET_ADDR     = 32'h00000000,
...
//------------------------AR channel begin---------------
//------------------------Instantiation------------------
    AFAProcessFunction_srcNet_m_axi_fifo #(
...
module AFAProcessFunction_srcNet_m_axi_write
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_TARGET_ADDR     = 32'h00000000,
...
//------------------------Body---------------------------
    ...
    if (USER_DATA_WIDTH == BUS_DATA_WIDTH) begin : bus_equal_gen
        ...
        AFAProcessFunction_srcNet_m_axi_decoder #(
            .DIN_WIDTH(PAD_ALIGN)
        ) head_pad_decoder (
            .din(head_pads),
            .dout(head_pad_sel));
