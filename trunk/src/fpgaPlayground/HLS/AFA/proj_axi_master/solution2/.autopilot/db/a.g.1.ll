; ModuleID = 'C:/Projects/2014-03-04_TLS-Aspect/FPGA/HLS/AFA2/AFA/proj_axi_master/solution2/.autopilot/db/a.g.1.bc'
...
define void @AFAProcessFunction(i32* %p, i8* %srcNet, i8* %dstNet) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i32* %p}, i64 0, metadata !184), !dbg !185 ; [debug line = 13:24] [debug variable = p]
  call void @llvm.dbg.value(metadata !{i8* %srcNet}, i64 0, metadata !186), !dbg !187 ; [debug line = 14:20] [debug variable = srcNet]
  call void @llvm.dbg.value(metadata !{i8* %dstNet}, i64 0, metadata !188), !dbg !189 ; [debug line = 15:20] [debug variable = dstNet]
  call void (...)* @_ssdm_op_SpecInterface(i32* %p, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i32 64, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !190 ; [debug line = 17:1]
  call void (...)* @_ssdm_op_SpecInterface(i8* %srcNet, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i32 256, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !192 ; [debug line = 18:1]
  call void (...)* @_ssdm_op_SpecInterface(i8* %dstNet, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i32 256, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !193 ; [debug line = 19:1]
  call void @llvm.dbg.declare(metadata !{[64 x i32]* %AFAProcessFunctionParamBlock}, metadata !194), !dbg !198 ; [debug line = 23:12] [debug variable = AFAProcessFunctionParamBlock]
  br label %burst.rd.header

burst.rd.header:                                  ; preds = %burst.rd.body, %0
  %indvar = phi i32 [ 0, %0 ], [ %indvar.next, %burst.rd.body ] ; [#uses=3 type=i32]
  %exitcond = icmp eq i32 %indvar, 64             ; [#uses=1 type=i1]
...
burst.rd.body:                                    ; preds = %burst.rd.header
  ...
  %1 = call i32 (...)* @_ssdm_op_SpecBurst(i32* %p, i32 1, i32 64) nounwind ; [#uses=0 type=i32]
  ...
  %4 = call i32 (...)* @_ssdm_op_SpecLoopName([38 x i8]* @str1) nounwind ; [#uses=0 type=i32]
  %indvar.next = add i32 %indvar, 1               ; [#uses=1 type=i32]
  %tmp = sext i32 %indvar to i64, !dbg !199       ; [#uses=2 type=i64] [debug line = 26:3]
  %p.addr = getelementptr i32* %p, i64 %tmp, !dbg !199 ; [#uses=1 type=i32*] [debug line = 26:3]
  %p.load = load i32* %p.addr, align 4, !dbg !199 ; [#uses=1 type=i32] [debug line = 26:3]
  %AFAProcessFunctionParamBlock.addr = getelementptr [64 x i32]* %AFAProcessFunctionParamBlock, i64 0, i64 %tmp, !dbg !199 ; [#uses=1 type=i32*] [debug line = 26:3]
  store i32 %p.load, i32* %AFAProcessFunctionParamBlock.addr, align 4, !dbg !199 ; [debug line = 26:3]
...
burst.wr.header:                                  ; preds = %burst.wr.body, %burst.wr.header.preheader
  %indvar4 = phi i32 [ %indvar.next5, %burst.wr.body ], [ 0, %burst.wr.header.preheader ] ; [#uses=3 type=i32]
  %exitcond6 = icmp eq i32 %indvar4, 64           ; [#uses=1 type=i1]
...
burst.wr.body:                                    ; preds = %burst.wr.header
  ...
  %5 = call i32 (...)* @_ssdm_op_SpecBurst(i32* %p, i32 0, i32 64) nounwind ; [#uses=0 type=i32]
  %6 = call i32 (...)* @_ssdm_SpecLoopFlatten(i32 1, [1 x i8]* @str7) nounwind ; [#uses=0 type=i32]
  %7 = call i32 (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @str6) nounwind ; [#uses=0 type=i32]
  %8 = call i32 (...)* @_ssdm_op_SpecLoopName([42 x i8]* @str5) nounwind ; [#uses=0 type=i32]
  %indvar.next5 = add i32 %indvar4, 1             ; [#uses=1 type=i32]
  %tmp.1 = sext i32 %indvar4 to i64, !dbg !200    ; [#uses=2 type=i64] [debug line = 27:3]
  %AFAProcessFunctionParamBlock.addr.1 = getelementptr [64 x i32]* %AFAProcessFunctionParamBlock, i64 0, i64 %tmp.1, !dbg !200 ; [#uses=1 type=i32*] [debug line = 27:3]
  %AFAProcessFunctionParamBlock.load = load i32* %AFAProcessFunctionParamBlock.addr.1, align 4, !dbg !200 ; [#uses=1 type=i32] [debug line = 27:3]
  %p.addr.1 = getelementptr i32* %p, i64 %tmp.1, !dbg !200 ; [#uses=1 type=i32*] [debug line = 27:3]
  store i32 %AFAProcessFunctionParamBlock.load, i32* %p.addr.1, align 4, !dbg !200 ; [debug line = 27:3]
...
burst.wr.end:                                     ; preds = %burst.wr.header
  ret void, !dbg !201                             ; [debug line = 28:1]
}
...
!184 = metadata !{i32 786689, metadata !156, metadata !"p", metadata !157, i32 16777229, metadata !160, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!185 = metadata !{i32 13, i32 24, metadata !156, null}
!186 = metadata !{i32 786689, metadata !156, metadata !"srcNet", metadata !157, i32 33554446, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!187 = metadata !{i32 14, i32 20, metadata !156, null}
!188 = metadata !{i32 786689, metadata !156, metadata !"dstNet", metadata !157, i32 50331663, metadata !164, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!189 = metadata !{i32 15, i32 20, metadata !156, null}
!190 = metadata !{i32 17, i32 1, metadata !191, null}
!191 = metadata !{i32 786443, metadata !156, i32 16, i32 1, metadata !157, i32 0} ; [ DW_TAG_lexical_block ]
!192 = metadata !{i32 18, i32 1, metadata !191, null}
!193 = metadata !{i32 19, i32 1, metadata !191, null}
!194 = metadata !{i32 786688, metadata !191, metadata !"AFAProcessFunctionParamBlock", metadata !157, i32 23, metadata !195, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!195 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 2048, i64 32, i32 0, i32 0, metadata !162, metadata !196, i32 0, i32 0} ; [ DW_TAG_array_type ]
!196 = metadata !{metadata !197}
!197 = metadata !{i32 786465, i64 0, i64 63}      ; [ DW_TAG_subrange_type ]
!198 = metadata !{i32 23, i32 12, metadata !191, null}
!199 = metadata !{i32 26, i32 3, metadata !191, null}
!200 = metadata !{i32 27, i32 3, metadata !191, null}
!201 = metadata !{i32 28, i32 1, metadata !191, null}
