...
enum
{
	AFA_PARAM_BLOCK_VERSION_MAJOR			= 0,
	AFA_PARAM_BLOCK_VERSION_MINOR			= 9000,
	AFA_PARAM_BLOCK_VERSION                 = ( AFA_PARAM_BLOCK_VERSION_MAJOR << 16 ) |AFA_PARAM_BLOCK_VERSION_MINOR,
	...
	AFA_PARAM_INDICES_VERSION,
	AFA_PARAM_INDICES_RETURN_VALUE,
    ...
    AFA_PARAM_INDICES_NUMBER_OF_INDICES,
	//
	AFA_PARAM_INDICES_COPY_START = AFA_PARAM_INDICES_VERSION
};
