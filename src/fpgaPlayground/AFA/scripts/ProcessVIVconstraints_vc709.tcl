...
set constraintCode10  {create_clock -period 10.000 -name pcie_refclk_clk_p -waveform {0.000 5.000} -add [get_ports pcie_refclk_clk_p]}
set constraintCode11  {set_property PACKAGE_PIN AB8     [get_ports pcie_refclk_clk_p]}
...
set constraintCode20  {set_property PACKAGE_PIN AM39    [get_ports c0_init_calib_complete]}
set constraintCode21  {set_property IOSTANDARD LVCMOS18 [get_ports c0_init_calib_complete]}

set constraintCode22  {set_property PACKAGE_PIN AR37    [get_ports c0_mmcm_locked]}
set constraintCode23  {set_property IOSTANDARD LVCMOS18 [get_ports c0_mmcm_locked]}
