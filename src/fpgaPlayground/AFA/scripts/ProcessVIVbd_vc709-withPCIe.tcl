...
set_property -name {CONFIG.XML_INPUT_FILE} -value "$prj_dir_resources/mig/mig_a.prj" -objects [get_bd_cells mig_7series_0]
...
delete_bd_objs [get_bd_nets c0_sys_clk_p_1]
delete_bd_objs [get_bd_nets c0_sys_clk_n_1]
delete_bd_objs [get_bd_ports c0_sys_clk_p]
delete_bd_objs [get_bd_ports c0_sys_clk_n]
startgroup
...
apply_bd_automation -rule xilinx.com:bd_rule:board -config {Board_Interface "pcie_refclk ( PCIe MGT reference Clock ) " }  [get_bd_intf_pins util_ds_buf_0/CLK_IN_D]
...
startgroup
create_bd_port -dir O c0_mmcm_locked
connect_bd_net [get_bd_pins /mig_7series_0/c0_mmcm_locked] [get_bd_ports c0_mmcm_locked]
endgroup
...
startgroup
create_bd_port -dir O c0_init_calib_complete
connect_bd_net [get_bd_pins /mig_7series_0/c0_init_calib_complete] [get_bd_ports c0_init_calib_complete]
endgroup
...
if { $CustomIPEnable == "yes" } {
	...
	startgroup
		create_bd_cell -type ip -vlnv $CustomIPNameFull AFAProcess_HW_0
	endgroup
	save_bd_design
...
#    set_property range 4G [get_bd_addr_segs {AFAProcess_HW_0/Data_m_axi_baseAddr/SEG_mig_7series_0_c0_memaddr}]
#    assign_bd_address [get_bd_addr_segs {mig_7series_0/c1_memmap/c1_memaddr }]
#	save_bd_design
}
...
puts "Importing XML definition of MIG7: $prj_dir_resources/mig/mig_a.prj"
set_property -name {CONFIG.XML_INPUT_FILE} -value $prj_dir_resources/mig/mig_a.prj -objects [get_bd_cells mig_7series_0]
set_property -name {CONFIG.RESET_BOARD_INTERFACE} -value  {Custom} -objects [get_bd_cells mig_7series_0]
set_property -name {CONFIG.MIG_DONT_TOUCH_PARAM} -value  {Custom} -objects [get_bd_cells mig_7series_0]
set_property -name {CONFIG.BOARD_MIG_PARAM} -value  {ddr3_sdram_socket_j1_j3} -objects [get_bd_cells mig_7series_0]
