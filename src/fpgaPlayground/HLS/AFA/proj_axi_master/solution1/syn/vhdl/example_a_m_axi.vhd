    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if fifo_rreq_valid = '1' and not rreq_handling then
                    rreq_handling <= true;
...
begin
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if fifo_wreq_valid = '1' and not wreq_handling then
                    wreq_handling <= true;
    ...
    BREADY      <= resp_ready;
    wrsp        <= bresp_tmp;
    wrsp_valid  <= resp_match;
    resp_ready  <= not (resp_match and not wrsp_ack);

    resp_read  <= resp_match and wrsp_ack;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (resp_read = '1' and not next_resp) then
                    resp_cnt <= (others => '0');
