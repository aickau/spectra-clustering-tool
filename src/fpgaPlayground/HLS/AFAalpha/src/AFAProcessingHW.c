...
bool_t
AFAProcess_HW(
		volatile unsigned char *addrMaster,		// start address of operation
		unsigned long param[ 512 ]				// whole block ram used
		)
{
#pragma HLS INTERFACE m_axi     port=addrMaster depth=10000 bundle=MASTER_BUS
