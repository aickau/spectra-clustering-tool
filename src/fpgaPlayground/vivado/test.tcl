...
#
# new.tcl: Tcl script for re-creating project 'SD'
#
# Generated by Vivado on Thu Apr 14 17:02:27 +0200 2016
...
#
# 1. This project restoration tcl script (new.tcl) that was generated.
#
...
#
#    "C:/Projects/2014-03-04_TLS-Aspect/viv/TCLTest6/res/SBD.bd"
#    "C:/Projects/2014-03-04_TLS-Aspect/viv/TCLTest6/res/board.prj"
#    "c:/Projects/2014-03-04_TLS-Aspect/viv/TCLTest6/res/ip/SBD_mig_7series_0_0/board.prj"
#    "C:/Projects/2014-03-04_TLS-Aspect/viv/TCLTest6/res/hdl/SBD_wrapper.vhd"
#
#*****************************************************************************************
...
set orig_proj_dir "[file normalize "$origin_dir/SimpleDesign"]"

# Create project
create_project SD ./SD

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects SD]
set_property "board_part" "xilinx.com:vc709:part0:1.7" $obj
set_property "compxlib.activehdl_compiled_library_dir" "$proj_dir/SD.cache/compile_simlib/activehdl" $obj
set_property "compxlib.funcsim" "1" $obj
set_property "compxlib.ies_compiled_library_dir" "$proj_dir/SD.cache/compile_simlib/ies" $obj
set_property "compxlib.modelsim_compiled_library_dir" "$proj_dir/SD.cache/compile_simlib/modelsim" $obj
set_property "compxlib.overwrite_libs" "0" $obj
set_property "compxlib.questa_compiled_library_dir" "$proj_dir/SD.cache/compile_simlib/questa" $obj
set_property "compxlib.riviera_compiled_library_dir" "$proj_dir/SD.cache/compile_simlib/riviera" $obj
set_property "compxlib.timesim" "1" $obj
set_property "compxlib.vcs_compiled_library_dir" "$proj_dir/SD.cache/compile_simlib/vcs" $obj
...
set files [list \
 "[file normalize "$origin_dir/res/SBD.bd"]"\
 "[file normalize "$origin_dir/res/board.prj"]"\
 "[file normalize "$origin_dir/res/ip/SBD_mig_7series_0_0/board.prj"]"\
 "[file normalize "$origin_dir/res/hdl/SBD_wrapper.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/res/SBD.bd"
...
set file "$origin_dir/res/board.prj"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
...
set file "$origin_dir/res/ip/SBD_mig_7series_0_0/board.prj"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
...
set file "$origin_dir/res/hdl/SBD_wrapper.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
