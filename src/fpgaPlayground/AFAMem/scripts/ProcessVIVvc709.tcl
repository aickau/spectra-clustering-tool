...
set block_design          "./ProcessVIV$platform_name\_BD_TestHW.tcl"
...
set proj_resources_dir    "[file normalize "$scripts_dir/res"]"
...
#write_cfgmem -format mcs -interface bpix16 -size 32 -loadbit  "up 0 [get_property top [current_fileset]].bit"  -file Untitled.mcs -force
#cd $cur_dir
