...
# - C0: set "Data Width" to "64" Bit
# - C1: set "Clock Period" to "1250ps"
# - C1: set "Data Width" to "64" Bit
...
set mig_location $proj_resources_dir/mig/$platform_name/mig_$CustomIPName.prj
puts "Importing XML definition of MIG7: $mig_location"
set_property -name {CONFIG.XML_INPUT_FILE} -value $mig_location -objects [get_bd_cells mig_7series_0]
...
if { $CustomIPEnable == "yes" } {
	...
	startgroup
		...
		apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config {Slave "/mig_7series_0/S1_AXI" Clk "Auto" }  [get_bd_intf_pins $CustomIPName/m_axi_gmem]
...
#	endgroup
	...
	connect_bd_net [get_bd_pins $CustomIPName/interrupt] [get_bd_pins microblaze_0_xlconcat/In1]
	puts "jesko7"
	save_bd_design

	# memory location of register set of HW block
	set_property offset 0x10000000 [get_bd_addr_segs microblaze_0/Data/SEG_$CustomIPName\_Reg]
	
	# memory location (only temporary) of param-block (bram block)
	set_property offset 0x70200000 [get_bd_addr_segs {microblaze_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property offset 0x70200000 [get_bd_addr_segs {microblaze_0/Instruction/SEG_axi_bram_ctrl_0_Mem0}]
	set_property offset 0x10010000 [get_bd_addr_segs $CustomIPName/Data_m_axi_gmem/SEG_axi_bram_ctrl_0_Mem0]
	puts "jesko9"
	save_bd_design
} else {
...
exclude_bd_addr_seg [get_bd_addr_segs $CustomIPName/Data_m_axi_gmem/SEG_mig_7series_0_c1_memaddr]
puts "jesko1a"
save_bd_design
...
set_property offset 0xC0000000 [get_bd_addr_segs $CustomIPName/Data_m_axi_gmem/SEG_axi_bram_ctrl_0_Mem0]

puts "jesko2"

## Set the Microblaze cache access regions (all regions that must be accessed by memory operations)

set_property offset 0x80000000 [get_bd_addr_segs $CustomIPName/Data_m_axi_gmem/SEG_mig_7series_0_c0_memaddr]
set_property range 1G [get_bd_addr_segs $CustomIPName/Data_m_axi_gmem/SEG_mig_7series_0_c0_memaddr]
puts "jesko3"
save_bd_design
