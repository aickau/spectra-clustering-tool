...
int main(int argc, char* argv[])
{
    ...
    spectraDataInputHW_OffsetToBaseAddress      = ( uint64_t )(( addr_t )(( char * ) AFAPP_sw.spectraDataInputHW      - (( char * ) baseAddr )));
    spectraDataWorkingSetHW_OffsetToBaseAddress = ( uint64_t )(( addr_t )(( char * ) AFAPP_sw.spectraDataWorkingSetHW - (( char * ) baseAddr )));
    pSpectraIndexList_OffsetToBaseAddress       = ( uint64_t )(( addr_t )(( char * ) AFAPP_sw.m_pSpectraIndexList     - (( char * ) baseAddr )));
    ...
    {
		print("---Exiting main---\n\r");
	    LEDRGBSet( 0, EVAL_BOARD_LEDRGB_BLACK );		// power off
		Xil_DCacheDisable();
		Xil_ICacheDisable();
    }
    return rv;
