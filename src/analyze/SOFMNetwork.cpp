...
,m_pAvgDistanceToBMU(NULL)
{
	...
	Helpers::print( std::string("Each spectrum uses ")+Helpers::numberToString(sizeof(Spectra)) + std::string(" bytes and has "+ Helpers::numberToString(Spectra::numSamples) + " pixels.\n"), m_pLogStream );
...
void SOFMNetwork::exportToHTML( const std::string &_sstrFilename, bool _fullExport )
{
	...
	sstrInfo +="<tr><td bgcolor=\"#800000\"></td><td>Type L</td></tr><tr><td bgcolor=\"#803300\"></td><td>Type T</td></tr><tr><td bgcolor=\"#009900\"></td><td>Carbon Stars</td></tr>";
	sstrInfo +="<tr><td bgcolor=\"#00EE00\"></td><td>CalciumWD</td></tr><tr><td bgcolor=\"#00FFFF\"></td><td>White Dwarfs</td></tr></table>";
	sstrInfo +=HTMLExport::lineBreak();
	sstrInfo +=HTMLExport::lineBreak();
